(function(exports){
    ...
    function sequential(div,data) {
        ...
        g.on("dblclick",function(d,i){
            d3.text("action/getCode/"+d.name+".scala",function(code){                
                if (editDiv == null) {
                    editDiv = d3.select("body").append("div")
                        .attr("style","width:40%;height:100%;position: absolute;top:0;right:0;")
                        .attr("id","code")
                    edit = ace.edit(editDiv.node())
    ...
    function ModelGraph(divId, data){
